...
class Sidebar_Block_Autoload {
	 ...
	 * @var     string
	 */
	private static $namespace = 'WebManDesign\Block\Sidebar';
	...
	public static function register( $class_name ) {
		...
		// Processing
			...
			$path = SIDEBAR_BLOCK_PATH . self::$directory . $path;
...
spl_autoload_register( 'Sidebar_Block_Autoload::register' );
